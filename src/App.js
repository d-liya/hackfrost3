  ...
  return (
    <div className="bg-gray-50">
      ...
      <body className="flex justify-center relative flex-col pt-[75px]">
        ...
        <section
          id="about-us"
          className="my-5 my-36  flex items-center justify-center"
        >
        ...
        >
          ...
          <h2 className="text-center text-6xl font-bold py-5 pb-24 text-gray-50 mx-40">
          ...
          <div className="flex justify-center">
            <div id="line" className="items-center flex flex-col">
              ...
              <InfoCard
                step={2}
                title="Packages en route to your door step"
        ...
        <section id="about">
          <div className="flex items-center justify-center w-[1150px] m-auto ">
        ...
        <section
          id="map"
          className="flex justify-center pb-20 mx-20 mt-36 items-center"
        >
          ...
          <div className="ml-10 min-w-[500px]">
            ...
            <p className="mt-5 text-xl">
              ECO₂ Drop's network of hyper-localized fulfillment centers is the
