  ...
  return (
    <div className="bg-gray-50">
      <header>
        <nav className="fixed top-0 w-full z-10 backdrop-blur bg-white/50">
          <ul className="flex justify-between items-center h-full py-5 mx-20">
            ...
            <li className="font-bold bg-black text-sm  text-gray-50 px-3 py-1">Contact us</li>
          </ul>
        </nav>
      </header>
      ...
      <body className="flex justify-center relative flex-col">
        <section id="intro" className="min-h-screen mb-5 mx-5 bg-emerald-900 rounded-lg flex items-center justify-center flex-col">
          <h1 className="text-6xl text-gray-50 font-bold mt-40 mx-32 text-center">Last Mile Delivery, With Zero Emissions</h1>
          <button className="bg-gray-50 text-emerald-900 font-bold rounded px-5 py-3 mt-10 mb-16 hover:bg-slate-200">Contact Us</button>
          <img src={process.env.PUBLIC_URL + "/images/delivery-man.jpg"} alt="delivery person" className="max-w-[80%] rounded-md" />
        </section>
        <section id="about" className="my-5">
          <h1 className="text-4xl font-bold text-center mb-5">Our Impact</h1>
          <p className="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam</p>
          <ul className="m-20">
            <li className="flex justify-between border-t py-14 items-center">
              ...
              <div className="">
                ...
                <p>Reduces carbon emissions by 80% compared to traditional delivery.</p>
              </div>
            </li>
            <li className="flex justify-between border-t py-14 items-center">
              ...
              <div className="">
                ...
                <p>Reduces carbon emissions by 20% compared to traditional delivery.</p>
              </div>
            </li>
            <li className="flex justify-between border-t py-14 items-center">
